...
/**
 * Servlet implementation class DeleteServeltpage
 */
@WebServlet("/DeleteServeltpage")
public class DeleteServeltpage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteServeltpage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<p style='color:red;'>❌ Error while Deleteing  data: " + e.getMessage() + "</p>");
        }
	}
